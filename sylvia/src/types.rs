...
/// [Remote::executor] method. ExecutorEmptyBuilder implements the
...
///         let exec_method = remote.executor().exec_method()?.build();
...
/// This structure is generated by the methods of the Executor trait,
/// created using Sylvia's contract and interface macros. It can then
/// be used to construct a Cosmos message, which is sent to
/// Sylvia contract via the execute endpoint.
///
/// ```rust
/// pub mod interface {
