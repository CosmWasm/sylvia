...
impl Contract {
    ...
    pub fn migrate_1_0_to_1_1(&self, _ctx: MigrateCtx, _val: u32) -> StdResult<Response> {
        Ok(Response::new())
    }

    #[msg(migrate, from = 1.1, to = 1.2)]
    pub fn migrate_1_1_to_1_2(&self, _ctx: MigrateCtx, _user: Addr) -> StdResult<Response> {
        Ok(Response::new())
    }
...
fn contract_messages_constructible() {
    ...
    let _ = contract::MigrateMsg::new().migrate_1_0_to_1_2();
