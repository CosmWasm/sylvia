...
pub mod signed_contract {
    ...
    use crate::{counter::Counter, ExampleMsg, ExampleQuery};

    pub struct SignedContract<'a> {
        counter: Item<'a, i32>,
    }
    ...
    impl Counter for SignedContract<'_> {
        type Error = StdError;
...
pub mod unsigned_contract {
    ...
    impl Counter for UnsignedContract<'_> {
        type Error = StdError;
        type ExecC = ExampleMsg;
        type QueryC = ExampleQuery;
        type CounterT = u32;
...
pub mod manager {
    ...
    pub struct ManagerContract<'a, CounterT> {
        remote_counter: Item<'a, InterfaceStorage<'a, CounterT>>,
    }
    ...
    #[sv::custom(msg=ExampleMsg, query=ExampleQuery)]
    impl<CounterT> ManagerContract<'_, CounterT>
    where
...
mod tests {
    ...
    fn setup(
        ...
        let manager_code_id = ManagerCodeId::<i32, _>::store_code(app);
        ...
        let manager_code_id = ManagerCodeId::<u32, _>::store_code(app);
