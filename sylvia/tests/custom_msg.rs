...
mod tests {
    ...
    fn test_custom() {
        ...
        contract
            ...
            .call(owner)
            .unwrap();
        contract.some_interface_proxy().interface_sudo().unwrap();

        // Other interface messages
        contract
            .other_interface_proxy()
            .other_interface_query()
            .unwrap();
        contract
            .other_interface_proxy()
        ...
        contract.interface_proxy().query().unwrap();
        contract.interface_proxy().exec().call(owner).unwrap();
        contract.interface_proxy().sudo().unwrap();
    }
}
